...
function VideoContent() {
    return (
        <div className="mt-4 aspect-video bg-mint/10 border-2 border-dashed border-mint/40 rounded-lg flex items-center justify-center">
            <div className="flex flex-col items-center gap-3">
                <div className="w-16 h-16 rounded-full bg-mint/20 flex items-center justify-center cursor-pointer hover:bg-mint/30 transition-colors">
                    <Play className="w-8 h-8 text-mint-dark ml-1" />
                </div>
...
function BinMemoriesForm() {
    return (
        <div className="mt-4 space-y-5">
            <p className="text-sm text-muted-foreground bg-mint/10 p-3 rounded-lg border border-mint/20">
            ...
            <DialogFooter>
                ...
                <Button className="bg-mint-dark hover:bg-[#135536] text-white font-semibold">Save Memory</Button>
            </DialogFooter>
        </div>
    );
}
...
function ExercisesPage() {
    ...
    return (
        <div className="min-h-screen bg-background">
                            ...
                            <DialogHeader>
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-full bg-mint/20 flex items-center justify-center">
                                        <selectedExercise.icon className="w-5 h-5 text-mint-dark" />
                                    </div>
                                    <div>
            ...
            <div className="bg-gradient-to-r from-mint/20 via-teal/10 to-mint/20 border-b border-mint/30">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {exercises.map((exercise) => (
                        <Card
                            ...
                            className="group cursor-pointer border-2 border-mint/30 hover:border-mint hover:shadow-lg hover:shadow-mint/10 transition-all"
                        >
                            <CardHeader className="text-center py-8">
                                <div className="mx-auto mb-4 w-14 h-14 rounded-full bg-mint/20 flex items-center justify-center group-hover:bg-mint/30 transition-colors">
                                    <exercise.icon className="w-7 h-7 text-mint-dark" />
                                </div>
                ...
                <div className="mx-auto max-w-4xl px-6 py-10">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
                        ...
                        <div className="flex gap-3">
                            <Button variant="outline" className="border-teal-dark text-teal-dark hover:bg-teal/10 font-semibold">
                                <Phone className="w-4 h-4 mr-2" />
                                Helplines
                            </Button>
                            <Button className="bg-teal-dark hover:bg-[#145c69] text-white font-semibold">
                                My Contacts
                            </Button>
                        </div>
                    </div>
            ...
            <div className="border-t border-border">
                <div className="mx-auto max-w-4xl px-6 py-8">
                    <div className="flex items-center justify-center gap-6 text-muted-foreground">
                        <button className="flex items-center gap-2 hover:text-mint-dark transition-colors">
